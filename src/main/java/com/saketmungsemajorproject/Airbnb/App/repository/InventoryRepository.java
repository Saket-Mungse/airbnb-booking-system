...
import com.saketmungsemajorproject.Airbnb.App.dto.RoomPriceDto;
...
public interface InventoryRepository extends JpaRepository<Inventory,Long> {
    ...
    @Modifying//Means you are updating something and you cannot acquire the lock inside Modifying query
    @Query("""
                UPDATE Inventory i
